...
// Compiles the C runtime for Vec, HashMap, HashSet, String, and File operations
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=src/runtime/file_runtime.c");
    ...
    cc::Build::new()
        ...
        .file("src/runtime/file_runtime.c")
